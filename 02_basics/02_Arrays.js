...
console.log(Array.from("devansh")); // we can anything to array
console.log(Array.from({name: "devansh"})); // interesting for interviews (convert values or keys for array we have to poitn which one)
